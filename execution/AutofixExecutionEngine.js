...
class AutofixExecutionEngine {
    constructor(config = {}) {
        ...
        this.fixMethods = {
            ...
            'REMOVE_LAUNCH_ACTIONS': 'removeLaunchActions',
            'REMOVE_EMBEDDED_FILES': 'removeEmbeddedFiles',
            'REMOVE_DOCUMENT_OPEN_ACTIONS': 'removeDocumentOpenActions',
            'REMOVE_PAGE_OPEN_ACTIONS': 'removePageOpenActions',
            'FLATTEN_ANNOTATIONS': 'flattenAnnotations',
            'FLATTEN_FORMS': 'flattenForms',
            'REBUILD_XREF': 'rebuildXref',
            'NORMALIZE_OBJECT_STREAMS': 'normalizeObjectStreams',
            'FLATTEN_TRANSPARENCY': 'flattenTransparency',
            'NORMALIZE_BLEND_MODES': 'normalizeBlendModes',
            'FLATTEN_PDF': 'flattenPdf',
            'FLATTEN_OVERPRINT': 'flattenOverprint',
            'SIMULATE_OVERPRINT_PREVIEW': 'simulateOverprintPreview',
            'NORMALIZE_OVERPRINT': 'normalizeOverprint',
            'REMOVE_SOFT_MASKS': 'removeSoftMasks',
            'RASTERIZE_TRANSPARENCY': 'rasterizeTransparency',
            'CONVERT_TO_PDFX_TRANSPARENCY_SAFE': 'convertToPdfxTransparencySafe',
            'EMBED_FONTS': 'embedFonts',
            'SUBSET_EMBEDDED_FONTS': 'subsetEmbeddedFonts',
            'OUTLINE_TYPE3_FONTS': 'outlineType3Fonts',
            'REPAIR_FONT_ENCODING': 'repairFontEncoding',
            'FLAG_MISSING_GLYPHS_UNFIXABLE': 'flagMissingGlyphsUnfixable',
            'VALIDATE_PDFX': 'validatePdfX',
            'VALIDATE_PDFA': 'validatePdfa',
            'CONVERT_TO_PDFX': 'convertToPdfx',
            'CONVERT_TO_PDFA': 'convertToPdfa',
            'STRIP_INVALID_PDFX_METADATA': 'stripInvalidPdfxMetadata',
            'STRIP_INVALID_PDFA_METADATA': 'stripInvalidPdfaMetadata',
            'NORMALIZE_STANDARD_METADATA': 'normalizeStandardMetadata',
            'REPAIR_PDFX_OUTPUTINTENT': 'repairPdfxOutputIntent',
            'MARK_STANDARD_UNCERTIFIED': 'markStandardUncertified',
            ...
            'NORMALIZE_BLACK_TEXT': 'normalizeBlackText',
            'DETECT_SMALL_TEXT_RICH_BLACK': 'detectSmallTextRichBlack',
